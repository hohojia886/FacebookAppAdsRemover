...
/*
// [2026-08-17 01:03] Original implementation:
object Logger {
...
object Logger {
    ...
    inline fun i(tag: String, msg: () -> String): Int = 
        if (BuildConfig.DEBUG) AndroidLog.i(tag, msg()) else 0

    fun i(tag: String, msg: String): Int = 
        if (BuildConfig.DEBUG) AndroidLog.i(tag, msg) else 0

    @JvmStatic
    inline fun w(tag: String, msg: () -> String): Int = 
        if (BuildConfig.DEBUG) AndroidLog.w(tag, msg()) else 0
    ...
    @JvmStatic
    inline fun e(tag: String, msg: () -> String): Int = 
        if (BuildConfig.DEBUG) AndroidLog.e(tag, msg()) else 0
